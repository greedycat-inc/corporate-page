...
<nav class="navbar navbar-expand-md bg-black px-5 fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarResponsive">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link js-smooth text-white" href="#contents">Contents</a>
      </li>
      <li class="nav-item">
        <a class="nav-link js-smooth text-white" href="#benefit">Restaurant benefits</a>
      </li>
      <li class="nav-item dropdown bg-black">
        ...
        <div class="dropdown-menu bg-black" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item text-white js-smooth" href="#target">Our Target Audience</a>
          <a class="dropdown-item text-white js-smooth" href="#about_us">About Us</a>
          <a class="dropdown-item text-white js-smooth" href="#available_location">Available Locations</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link js-smooth text-white" href="#statics">Statistics</a>
      </li>
      <li class="nav-item">
        <a class="nav-link js-smooth text-white" href="#headquarter">Our Headquarters</a>
      </li>
      <li class="nav-item bg-black">
        <a class="nav-link text-white js-smooth" href="#top">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-7 text-left py-5">
        ...
        <p>
          ...
          Currently being utilized by international visitors helping them with their dining, shopping, and travel adventures while in the USA.<br/>
...
<section id="about_us">
  <div class="container py-6rem">
    <div class="row">
      <div class="col-12 col-md-5 text-center">
        <img src="/assets/images/about_us.png" class="w-100">
      </div>
      <div class="col-12 col-md-7 text-left py-5">
        <h2 class="fs-42 fc-green pb-4">
          About Us       
...
<section id="available_location">
  <div class="container py-6rem">
    <div class="row">
      <div class="col-12 col-md-5 text-center order-md-2">
        <img src="/assets/images/available_location.png" class="w-100">
      </div>
      <div class="col-12 col-md-7 text-left py-5 order-md-1">
        <h2 class="fs-42 fc-green pb-4">
          Available Locations
